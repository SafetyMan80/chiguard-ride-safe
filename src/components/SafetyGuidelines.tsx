        ...
        <CardContent className="space-y-6 text-sm">
          ...
          <section>
            ...
            <div className="text-muted-foreground space-y-2">
              ...
              <p>• Use RailSafe's SOS button to alert nearby riders and get community support</p>
          ...
          <section>
            ...
            <div className="text-muted-foreground space-y-2">
              ...
              <p>• Report incidents accurately through RailSafe to help others stay informed</p>
          ...
          <section>
            <h3 className="font-semibold mb-2">📱 Using RailSafe Safely</h3>
            <div className="text-muted-foreground space-y-2">
